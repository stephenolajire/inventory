  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="ml-1.5 text-[9px] font-bold uppercase tracking-widest text-text-muted align-middle">
          Admin
        </span>
      </span>
    </Link>
  ...
  return (
    <div className="space-y-0.5">
      ...
      {group.items.map((item) => {
        const badge =
          item.label === "Pending Approval" ? pendingCount : item.badge;
        return (
          <SidebarNavItem
            key={item.href}
            item={{ ...item, badge }}
...
interface AdminSidebarProps {
  onLogout: () => void;
  /** Pass pending vendor count from your admin summary query */
  pendingCount?: number;
}
